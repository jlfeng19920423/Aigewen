...
namespace BloogBot.Game
{
    internal class Fields_45327
    {
        ...
        public class Unit
        {
            ...
            public const int Level = 0xD5C8; // Updated
            public const int Health = 0xD3A8; // Updated
            public const int MaxHealth = 0xD4D0; // Updated


            public const int Sex = 0xD5BF; // Updated => ?
            public const int Race = 0xD5BC; // Updated => ?
            public const int Class = 0xD5BD; // Updated => ?


            public const int Target = 0xD588; // Updated
            ...
            public const int MaxPower1 = 0xD7FC; // Updated
            public const int MaxPower2 = 0xD800; // Updated
