    ...
    public static class MemoryAddresses
    {
        ...
        static MemoryAddresses()
        {
            ...
            if(false)
            {
                ...
                EnumerateVisibleObjectsFunPtr = 0x572630; //linfeng
                GetObjectPtrFunPtr = 0x0046b520;
                GetPlayerGuidFunPtr = 0x2B707C0;
            ...
            FindSlotBySpellId_Ptr = 0x0; //??
            CastSpellBySlot_Ptr = 0x1586CA0;
            Dismount_Ptr = 0x0;
            FindSpellBookSlotBySpellID_Ptr = 0x0;
            PetStopAttack_Ptr = 0x0;
        }
        ...
        //linfeng
        public static int Dismount_Ptr;
        public static int FindSlotBySpellId_Ptr;
        public static int FindSpellBookSlotBySpellID_Ptr;
        public static int CastSpellBySlot_Ptr;
        public static int PetStopAttack_Ptr;
