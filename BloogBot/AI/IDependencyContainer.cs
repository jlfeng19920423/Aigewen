...
namespace BloogBot.AI
{
    public interface IDependencyContainer
    {
        ...
        Func<Stack<IBotState>, IDependencyContainer, IBotState> CreateRetrieveCorpseState { get; }

        Func<Stack<IBotState>, IDependencyContainer, IBotState> CreateMoveToCorpseState { get; }
