...
namespace BloogBot.AI.SharedStates
{
    public class TravelState : IBotState
    {
        ...
        public void Update()
        {
            ...
            if (player.UnitPosition.DistanceTo(travelPathWaypoints[travelPathIndex]) < 3)
                travelPathIndex++;
            ...
            Position destination = travelPathWaypoints[travelPathIndex];
            ...
            if (posPtr != IntPtr.Zero) ThreadSynchronizer.RunOnMainThread(() => Functions.ClickToMoveMoveTo(player.EntPtr, posPtr));
        }
    }
}
