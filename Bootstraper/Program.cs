...
namespace Bootstraper
{
    class Program
    {
        ...
        const string PATH_TO_GAME = @"I:\WOW60\robot\WOW\Wow.exe";
        ...
        static void Main(string[] args)
        {
            ...
            */
            ...
            Console.WriteLine("读取进程id:{0}",pid);
            Process process = Process.GetProcessById(pid);

            //var processHandle = OpenProcess(PROCESS_VM_READ, false, process[0].Id);
            var processHandle = Process.GetProcessById(process.Id).Handle;
